    ...
    <div class="master-container">
        ...
        <div class="master-control" style="padding-bottom: 1%;">
            <div class="master-navigation">
                ...
                <div class="master-navigation-wrapper">
                    <a href="/masterRpost"><i class="fas fa-comment-alt" style="color: #7fccbf;"></i> <span id="nav-master" style="color:#253f58">Master Review Forum</span></a>
                </div>
                <div class="master-navigation-wrapper">
            ...
            <div class="master-content">
                <div class="master-title">
                    <h1 style="margin: 0;color: #17293b;font-family: 'Montserrat', sans-serif;">Master Review Post</h1>
                </div>
                <div class="master-trans-content">
                    ...
                    <div class="master-trans-table">
                        <table>
                            <thead>
                                <tr>
                                    <th class="font-primary color-secondary">Tanggal Review</th>
                                    <th class="font-primary color-secondary">Judul Post</th>
                                    <th class="font-primary color-secondary">Nama Uploader</th>
                                    <th class="font-primary color-secondary">Nama Reviewer</th>
                                    <th class="font-primary color-secondary">Like</th>
                                    <th class="font-primary color-secondary">Isi Komentar</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($rpost as $rp)
